...
const songs = [
    ...
    },
    {
        ...
        <div class="subtitle">Tamashh</div>`,
        poster: "images/7.jpg"
    },
    {
        id:8,
    ...
    },
    {
        ...
        <div class="subtitle">Neeti Zindagi ft Jubin Nautiyal</div>`,
        poster: "images/16.jpg"
    },
    {
        id:17,
        songName: `Batao Yaad Hai Wo Jab Dil Ko Churaya Tha  <br>
        <div class="subtitle"> The Audio</div>`,
        poster: "images/17.jpg"
    },
    {
        id:18,
        songName: `Mere Dhol JUdaiyan <br>
        <div class="subtitle">Ali Sethi Seh</div>`,
        poster: "images/18.jpg"
    },
    {
        id:19,
        songName: `Huniachi  <br>
        <div class="subtitle">Reuben Kigame  Sifa Voices ft  Gloria Muliro </div>`,
        poster: "images/19.jpg"
    },
    {
        id:20,
        songName: `Uinuliwe<br>
        <div class="subtitle">Pst Epa</div>`,
...
let index = 0;
let poster_play_box = document.getElementById('poster_play_box');
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    ...
    poster_play_box.src = `images/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
